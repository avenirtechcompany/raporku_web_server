...
// import Semester from "./semester_model.js";

const { DataTypes } = Sequelize;

const NilaiSiswa = db.define(
  "nilai_siswa",
  {
    id_nilai_siswa: {
...
NilaiSiswa.belongsTo(TahunAjaran, {
  foreignKey: "kode_tahun_ajaran",
  onDelete: "SET NULL",
  onUpdate: "CASCADE",
});

TahunAjaran.hasMany(NilaiSiswa, {
  foreignKey: "kode_tahun_ajaran",
  onDelete: "SET NULL",
  onUpdate: "CASCADE",
});

// NilaiSiswa.belongsTo(Semester, {
//   foreignKey: "kode_semester",
//   onDelete: "SET NULL",
//   onUpdate: "CASCADE",
// });

// Semester.hasMany(NilaiSiswa, {
//   foreignKey: "kode_semester",
//   onDelete: "SET NULL",
//   onUpdate: "CASCADE",
// });
